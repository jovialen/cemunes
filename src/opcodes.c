...
#define UNOFFICIAL_NOP_INSTRUCTION(MODE) { .valid = true, .unofficial = true, .name = "nop", .func = &unop, .addr_mode = MODE }

static void unop(cpu_t *cpu, cpu_addressing_mode_t mode) {
  if (mode != CPU_ADDRESSING_MODE_IMPLIED) {
    // Don't actually care about the result, just want to progress the pc
    cpu_mem_read_u8(cpu, mode);
  }
}
...
static void rla(cpu_t *cpu, cpu_addressing_mode_t mode) {
  uint8_t *m = cpu_mem_addr(cpu, mode);
  uint8_t carry = cpu->registers.flags & CPU_STATUS_FLAG_CARRY;
...
const cpu_instruction_t INSTRUCTIONS[INSTRUCTION_COUNT] = {
  ...
  [0x80] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMMEDIATE),
  [0x82] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMMEDIATE),
  [0xc2] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMMEDIATE),
  [0xe2] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMMEDIATE),
  [0x04] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE),
  [0x44] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE),
  [0x64] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE),
  [0x89] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMMEDIATE),
  [0x0c] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE),
  [0x14] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_X),
  [0x34] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_X),
  [0x54] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_X),
  [0x74] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_X),
  [0xd4] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_X),
  [0xf4] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_X),
  [0x1a] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMPLIED),
  [0x3a] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMPLIED),
  [0x5a] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMPLIED),
  [0x7a] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMPLIED),
  [0xda] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMPLIED),
  [0xfa] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_IMPLIED),
  [0x1c] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE_X),
  [0x3c] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE_X),
  [0x5c] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE_X),
  [0x7c] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE_X),
  [0xdc] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE_X),
  [0xfc] = UNOFFICIAL_NOP_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE_X),
  ...
  [0xb6] = LDX_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_Y),
  [0xae] = LDX_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE),
  [0xbe] = LDX_INSTRUCTION(CPU_ADDRESSING_MODE_ABSOLUTE_Y),
  ...
  [0x96] = STX_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_Y),
  ...
  [0x27] = RLA_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE),
  [0x37] = RLA_INSTRUCTION(CPU_ADDRESSING_MODE_ZERO_PAGE_X),
  [0x23] = RLA_INSTRUCTION(CPU_ADDRESSING_MODE_INDIRECT_X),
  [0x33] = RLA_INSTRUCTION(CPU_ADDRESSING_MODE_INDIRECT_Y),
